...
class Simulator:
    ...
    def simulate(self):
        ...
        for person_ind in range(0,len(self.people)):
            if self.people[person_ind].current_state == 1: #------QUESTION
                ...
                for i in range(0, len(self.locations[loc_ind].people)):
                    ...
                    for j in range(0, len(self.locations[loc_ind].people)):
                        ...
                        if person_2 == 2:
                            ...
                            continue
                        #Collision
                        val_infect_location = location.protocol.P.sample(1) #----QUESTION
                        #thresh = 0.2
                        """
                        ...
                        if abs(val_infect_location) > location.thresh[loc_ind] and self.states[t_ind+1][person_2_id] != 1: #Collision
